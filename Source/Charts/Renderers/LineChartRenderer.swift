...
open class LineChartRenderer: LineRadarRenderer
{
    ...
    private func generateFilledPath(dataSet: LineChartDataSetProtocol, fillMin: CGFloat, fillOverlapEnabled: Bool, bounds: XBounds, matrix: CGAffineTransform) -> CGPath
    {
        guard let dataProvider = dataProvider else { return CGMutablePath() }

        var lowerDataSet: ChartDataSetProtocol?
